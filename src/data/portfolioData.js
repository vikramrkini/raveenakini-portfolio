...
import viceChancellorImage from '../assets/Vice Chancellors Merit Certificate.jpg'
import goldMedalImage from '../assets/Certificate and Gold Medal MBIAP.jpg'
import challengerImage from '../assets/Physiotimes Clinical Challenger Award.jpg'
import physioTVImage from '../assets/Physio TV Webinar.jpg'
import bestTeacher2023Image from '../assets/Best Teacher MGM COP 2022-23.jpg'
import bestTeacher2025Image from '../assets/Best Teacher MGM COP 2024-25.jpg'
import bestEPosterImage from '../assets/Best E POSTER ISHT.jpg'
import bookReleaseImage from '../assets/Book release- Can you spot it.jpg'
import certificateInnovationImage from '../assets/20251116_111809.jpg'
...
export const aboutParagraphs = [
  ...
  'Founder of Reform the Physio Way since 2020, Dr. Raveena helps patients restore movement, strength, and confidence through evidence-based care.',
...
export const navLinks = [
  ...
  { label: 'Contact Dr Raveena Kini (PT)', path: '/contact' },
]
...
export const aboutStats = [
  ...
  { label: 'Advanced modalities', value: '8 techniques', detail: 'Manual therapy, dry needling, fascial work, and more.' },
  {
    ...
    value: 'Multiple publications',
    detail: 'Former Assistant Professor of Musculoskeletal Physiotherapy while authoring evolving studies.',
  },
]
...
export const achievementList = [
  {
    ...
    detail: 'Recipient of the Dorabjee Tata Scholarship during all undergraduate years for academic excellence.',
  ...
  },
  {
    ...
    year: '2020',
    detail:
      'Awarded the Vice Chancellor’s Merit Certificate for standing First in Maharashtra University of Health Sciences, Nashik, for post-graduation in Musculoskeletal Physiotherapy.',
    image: viceChancellorImage,
  },
  {
    title: 'Gold Medal & IAP Certificate',
    year: '2020',
    detail:
      'Honoured with a Gold Medal and Certificate by the Mumbai Branch of the Indian Association of Physiotherapist for academic excellence in post-graduation.',
  ...
  },
  {
    ...
    year: '2021',
    detail:
      'Recipient of the Challenger in Clinical Expertise Award from Physiotimes Magazine in 2021.',
  ...
  },
  {
    ...
    year: 'March 2022',
    detail:
      'Invited as a speaker by PhysioTV (Sancheti Hospital Pune) to deliver “An introduction to Traumatic Brachial Plexus Injury Rehabilitation.”',
    image: physioTVImage,
  },
  {
    title: 'Best Teacher Award',
    year: 'March 2023',
    detail: 'Recipient of Best Teacher Award, MGM College of Physiotherapy, Navi Mumbai in March 2023.',
    image: bestTeacher2023Image,
  },
  {
    title: 'Certificate of Innovation',
    year: 'April 2024',
    detail:
      'Recognized with a Certificate of Innovation for implementing the first competency-based training program for undergraduate students at MGM College of Physiotherapy in April 2024.',
    image: certificateInnovationImage,
  },
  {
    title: 'Best E-Poster Award',
    year: 'SHTICON 2024',
    detail:
      'Recipient of Best E-Poster Award, SHTICON 2024, for the study “Impact of the use of computerized simulation education and video-based learning in combination with kinaesthetic learning in delivering a session on Wrist and Hand assessment in third-year physiotherapy undergraduates — a qualitative study.”',
    image: bestEPosterImage,
  },
  {
    title: 'Best Teacher Award',
    year: 'June 2025',
    detail: 'Recipient of Best Teacher Award, MGM College of Physiotherapy, Navi Mumbai in June 2025.',
    image: bestTeacher2025Image,
  },
  {
    title: 'Book Chapters',
    year: '2024',
    detail:
      'Contributor for 2 chapters in the book “Investigations Simplified: Can You Spot it?” which got published in 2024. https://www.amazon.in/Investigation-Simplified-Can-You-Spot/dp/9394525823',
    image: bookReleaseImage,
  },
]
